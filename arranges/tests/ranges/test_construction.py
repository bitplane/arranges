...
def test_from_sequence():
    ranges = Arranged([1, 2, 3, 4])

    assert ranges == Arranged("1:5")


def test_from_nested_mess():
    ranges = Arranged([[1, [2], ["101:201,30:31"], 3], range(10, 15)])

    assert ranges == Arranged("1:4,10:15,30:31,101:201")
